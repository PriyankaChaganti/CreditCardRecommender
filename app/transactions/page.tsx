    ...
    <form onSubmit={(e) => { e.preventDefault(); onSubmit(form); }} className="flex flex-col gap-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={inputCls}
        />
        {/* Unknown merchant hint */}
        {form.merchant.length >= 2 && suggestions.length === 0 && !showSuggestions && (
          <p className="mt-1.5 flex items-center gap-1.5 text-xs text-amber-600 dark:text-amber-400">
            ...
            Merchant not recognised — please make sure the category below is correct.
          </p>
        )}
